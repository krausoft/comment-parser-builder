...
const crb = __importStar(require("../src/comment-regexp-builder"));
...
describe('startTag innerText method', () => {
    ...
    test('innerText recognizes its tag description', () => {
        const tg = crb.createStartTag('//');
        expect(tg.innerText(' // this is a description  ')).toEqual(' this is a description  ');
...
//# sourceMappingURL=comment-regexp-builder.test.js.map